...
/* harmony import */ var _components_theme__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_theme__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_portfolio_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/portfolio-slider */ "./src/js/components/portfolio-slider.js");
...
function burgerMenu() {
  ...
  var burgerMenu = document.querySelector('.burger-menu'); // let pageBlackout = document.querySelector('.page-blackout');

  var nav = document.querySelectorAll('.navigation');
  nav.forEach(function (el) {
    var navElems = el.querySelectorAll('.navigation__link');
    var navRound = el.querySelector('.navigation__round');
    navElems.forEach(function (el) {
      el.addEventListener('mouseenter', function () {
        navRound.style.top = el.offsetTop + 4 + 'px';
      });
      el.addEventListener('mouseleave', function () {
        navRound.style.top = 4 + 'px';
      });
    });
  });
  document.addEventListener('keydown', function (e) {
    if (e.keyCode === 27 && burger.classList.contains('burger--active')) {
      burger.classList.toggle('burger--active');
      burgerMenu.classList.toggle('burger-menu--active');
    }
  });
  document.addEventListener('click', function (e) {
    var isBurger = e.target === burger || burger.contains(e.target);
    var isBurgerMenu = e.target === burgerMenu || burgerMenu.contains(e.target);
  ...
  //   burger.classList.toggle('burger--active');
  //   burgerMenu.classList.toggle('burger-menu--active');
  //   // pageBlackout.classList.toggle('page-blackout--active');
  // });
}
...
function hideLoader() {
  ...
  setTimeout(function () {
    return loader.classList.add('visually-hidden');
  }, 500);
}
...
/***/ "./src/js/components/portfolio-slider.js":
/*!***********************************************!*\
  !*** ./src/js/components/portfolio-slider.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ "./node_modules/swiper/esm/components/parallax/parallax.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var portfolioSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio-slider', {
    loop: false,
    speed: 2400,
    navigation: {
      nextEl: swiperNext,
  ...
  var portfolioSliderCurrent = document.querySelector('.portfolio-slider__current');
  var portfolioSliderCount = document.querySelector('.portfolio-slider__count');
  portfolioSliderCount.innerHTML = portfolioSlider.slides.length;
  portfolioSlider.on('slideChange', function () {
    gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.to(portfolioSliderCurrent, {
      force3D: true,
      y: -10,
      opacity: 0,
      duration: 0.2,
      ...
      onComplete: function onComplete() {
        ...
        portfolioSliderCurrent.innerHTML = portfolioSlider.realIndex + 1;
      }
    });
    gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.to(portfolioSliderCurrent, {
      force3D: true,
...
function tabs() {
  ...
  if (tabs) {
    var tabsList = tabs.querySelectorAll('.tabs__btn');
    var tabsContent = tabs.querySelectorAll('.tabs__content');
    tabsList.forEach(function (el) {
      el.addEventListener('click', function () {
        tabsList.forEach(function (el) {
          return el.classList.remove('tabs__btn--active');
        });
        el.classList.add('tabs__btn--active');
        var currentTabPath = el.getAttribute('data-path-tabs');
        var currentContent = tabs.querySelector(".tabs__content[data-tabs-target=\"".concat(currentTabPath, "\"]"));
...
function theme() {
  ...
  var checkedElement = document.querySelector("#".concat(localStorage.getItem('theme')));
  checkedElement.checked = true;
  var radioContainer = document.querySelectorAll('.choice-theme');
  radioContainer.forEach(function (el) {
    var radioInputs = el.querySelectorAll('.choice-theme__radio');
    radioInputs.forEach(function (el) {
      el.addEventListener('click', function () {
        document.body.dataset.theme = el.id;
